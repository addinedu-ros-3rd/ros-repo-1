...
class DetectBall3d(Node):
    ...
    def __init__(self):
        ...
        self.ball3d_pub  = self.create_publisher(Point,"/detected_ball_3d",10)
        self.ball_marker_pub  = self.create_publisher(Marker,"/ball_3d_marker",10)

        self.declare_parameter("h_fov",1.089)
        self.declare_parameter("ball_radius",0.034)
