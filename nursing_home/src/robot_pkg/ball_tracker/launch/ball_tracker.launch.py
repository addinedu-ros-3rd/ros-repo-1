...
def generate_launch_description():
    ...
    params_file_dec = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(get_package_share_directory('ball_tracker'),'config','ball_tracker_params_robot.yaml'),
    ...
    'cmd_vel_topic',
    default_value='/base_controller/cmd_vel_unstamped',  # /base_controller/cmd_vel_unstamped
